...
class _FlutterLoginState extends State<FlutterLogin>
  ...
  bool isSignUpDefined = true;
  bool isForgotPasswordDefined = true;

  @override
  void initState() {
    super.initState();
    isSignUpDefined = widget.onSignup != null;
    isForgotPasswordDefined = widget.onRecoverPassword != null;
                  ...
                  children: <Widget>[
                    Positioned(
                      child: AuthCard(
                        ...
                        isSignUpEnabled: isSignUpDefined,
                        isForgotPasswordEnabled: isForgotPasswordDefined,
                      ),
                    ),
                    Positioned(
